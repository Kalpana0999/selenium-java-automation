...
public class PageActions {
    ...
    //By locTotalPayment = By.xpath("//td[@id='year2023']/following-sibling::td[3]");
    ...
    public void getEmiValues(WebDriver driver) {
        WebElement lblLoanEmi = driver.findElement(locLoanEmi);
        WebElement lblTotalInterest = driver.findElement(locTotalInterestPayable);
        WebElement lblTotalPayment = driver.findElement(locTotalPayment);

        System.out.println("---------- Breakup of Total Payment ----------");
        System.out.println(" Loan EMI = " +lblLoanEmi.getText()+"\n Total Interest Payable = "+lblTotalInterest.getText()+"\n Total Payment(Principal + Interest) = "+lblTotalPayment.getText()+"\n");
    }

    public void getYearlyValues(WebDriver driver) {
        WebElement lblYear = driver.findElement(locYear);
        WebElement lblPrincipal = driver.findElement(locPrincipal);
        WebElement lblInterest = driver.findElement(locInterest);
        WebElement lblTotalPayment = driver.findElement(locTotalPayment);
        WebElement lblBalance = driver.findElement(locBalance);
        WebElement lblLoanPaid = driver.findElement(locLoanPaid);

        System.out.println("--------------- Payments for the year 2023 ----------");
        System.out.println(" Year = "+lblYear.getText()+"\n Principal (A) = "+lblPrincipal.getText()+"\n Interest (B) = "+lblInterest.getText()+"\n Total Payment (A + B) = "+lblTotalPayment.getText()+"\n Balance = "+lblBalance.getText()+"\n Loan Paid To Date = "+lblLoanPaid.getText());
    }
}
